...
<body>
    ...
    <ul class="list-unstyled components">
        ...
        <div class="container">
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="custom-gridview" AutoGenerateColumns="False" DataKeyNames="LESSONNO,COURSEID,STUDENTID" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True">
