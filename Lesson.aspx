<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lesson.aspx.cs" Inherits="istitution.Lesson" %>
...
<ControlStyle CssClass="delete-button"></ControlStyle>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" DeleteCommand="DELETE FROM &quot;LESSON&quot; WHERE &quot;LESSONNO&quot; = :LESSONNO" InsertCommand="INSERT INTO &quot;LESSON&quot; (&quot;LESSONNO&quot;, &quot;COURSEID&quot;, &quot;LESSONTITLE&quot;) VALUES (:LESSONNO, :COURSEID, :LESSONTITLE)" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM &quot;LESSON&quot;" UpdateCommand="UPDATE &quot;LESSON&quot; SET &quot;COURSEID&quot; = :COURSEID, &quot;LESSONTITLE&quot; = :LESSONTITLE WHERE &quot;LESSONNO&quot; = :LESSONNO">
                <DeleteParameters>
