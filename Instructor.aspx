<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Instructor.aspx.cs" Inherits="istitution.Instructor" %>
...
<body>
    ...
    <ul class="list-unstyled components">
        ...
        <div class="container">
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="custom-gridview" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="INSTRUCTORID" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True">
...
<ControlStyle CssClass="delete-button"></ControlStyle>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" DeleteCommand="DELETE FROM &quot;INSTRUCTOR&quot; WHERE &quot;INSTRUCTORID&quot; = :original_INSTRUCTORID" InsertCommand="INSERT INTO &quot;INSTRUCTOR&quot; (&quot;INSTRUCTORID&quot;, &quot;INSTRUCTORNAME&quot;) VALUES (:INSTRUCTORID, :INSTRUCTORNAME)" OldValuesParameterFormatString="original_{0}" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM &quot;INSTRUCTOR&quot;" UpdateCommand="UPDATE &quot;INSTRUCTOR&quot; SET &quot;INSTRUCTORNAME&quot; = :INSTRUCTORNAME WHERE &quot;INSTRUCTORID&quot; = :original_INSTRUCTORID">
                <DeleteParameters>
                    <asp:Parameter Name="original_INSTRUCTORID" Type="Decimal" />
                </DeleteParameters>
                <InsertParameters>
